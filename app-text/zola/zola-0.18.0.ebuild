...
# ring: custom license (`ring`)
#   > "*ring* is derived from BoringSSL, so the licensing situation
#   > in *ring* is similar to BoringSSL."
# tinystr: UNICODE LICENSE v3 (`Unicode-3.0`).
LICENSE="Apache-2.0 BSD BSD-2 CC0-1.0 ISC MIT MPL-2.0 Unicode-3.0 Unicode-DFS-2016 ring"
SLOT="0"
KEYWORDS="~amd64 ~x86"
