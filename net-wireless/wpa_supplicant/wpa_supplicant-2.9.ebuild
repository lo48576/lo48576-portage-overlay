...
# 2019-10-06: Modified to make CRDA optional.
# See:
# * <https://bugs.gentoo.org/462032>
# * <https://462032.bugs.gentoo.org/attachment.cgi?id=361960>
# * <https://github.com/gentoo/gentoo/blob/9aed687459cc4b09f686c41ed19338dfdd73bfb1/net-wireless/iwd/iwd-0.21.ebuild>
...
src_configure() {
	...
	# Enable kernel support for CRDA.
	if ! use crda ; then
		# To see why `CFG80211` should be `m`, see
		# <https://github.com/gentoo/gentoo/blob/9aed687459cc4b09f686c41ed19338dfdd73bfb1/net-wireless/iwd/iwd-0.21.ebuild#L89-L92>.
		Kconfig_style_config CFG80211 m
		Kconfig_style_config CFG80211_CRDA_SUPPORT y
	fi
}
